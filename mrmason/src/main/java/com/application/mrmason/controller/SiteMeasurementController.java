...
public class SiteMeasurementController {
    ...
    @PreAuthorize("hasAuthority('EC') and !hasAuthority('Developer')")
    ...
    public ResponseEntity<?> getSiteMeasurement(
    	...
    	try {
    	    List<SiteMeasurement> sm = siteMeasurementService.getSiteMeasurement(serviceRequestId,eastSiteLegth,location);
