	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.cors(AbstractHttpConfigurer::disable).csrf(AbstractHttpConfigurer::disable)
				...
				.authorizeHttpRequests(auth -> auth.requestMatchers("/login", "/addAdminDetails", "/adminLoginWithPass",
						...
						"/admin/forgetPassword/sendOtp", "/admin/forgetPassword/verifyOtpAndChangePassword","/getData","/getServiceCategory/civil/{serviceCategory}","/getServiceCategory/nonCivil/{serviceCategory}").permitAll()
