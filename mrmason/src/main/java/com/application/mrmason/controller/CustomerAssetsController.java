...
public class CustomerAssetsController {
	...
	public ResponseEntity<ResponseCustomerAssetsDto> getAssets(@RequestParam(required = false) String userId,
		...
		Page<?> assetsPage = assetService.getAssets(userId, assetId, location, assetCat, assetSubCat, assetModel,
				assetBrand, pageable, regSource);
	...
	@PostMapping("/upload-images-by-machine")
	public ResponseEntity<?> uploadDocs(@RequestParam("assetId") String assetId,
			@RequestParam(value = "image", required = false) MultipartFile image, @RequestParam RegSource regSource)
			throws AccessDeniedException {
		return assetService.uploadprofileimage(assetId, image, regSource);
	}
//	public ResponseEntity<ResponseCustomerAssetsDto> getAssets(@RequestParam(required = false) String userId,
//			@RequestParam(required = false) String assetId, @RequestParam(required = false) String location,
//			@RequestParam(required = false) String assetCat, @RequestParam(required = false) String assetSubCat,
